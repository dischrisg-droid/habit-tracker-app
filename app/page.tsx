      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-3 gap-10">
          <Link href="/habits" className="group">
            <div className="bg-white/80 backdrop-blur-xl rounded-3xl p-16 shadow-2xl hover:shadow-3xl hover:-translate-y-6 transition-all duration-500 border border-white/50 h-64 flex items-center justify-center">
