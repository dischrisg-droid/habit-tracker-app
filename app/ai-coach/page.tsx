// app/ai-coach/page.tsx — 100% FINAL & WORKING
'use client';
...
export default function AICoachPage() {
  const { personality, habits, logs, saveAIPlan } = useStore(); // ← THIS LINE IS CORRECT
  ...
  useEffect(() => {
    ...
    const videoRec = charismaVideos[mbti] || { name: 'Tom Hanks', video: 'https://www.youtube.com/watch?v=Rb0h6uMcw2I' };

    const generatedPlan = `
Tomorrow belongs to **${mbti} ${enneagram}** becoming: "${personality.whoIWantToBe}"

You completed ${completed}/${total} habits today.

**6 Higher Faculties – Your Plan**

**Imagination** • 7-min visualization of your future self  
**Will** • Do your most important habit first — no excuses  
**Perception** • 3x tomorrow: fully notice one thing with all senses  
**Reason** • Protect your bedtime like it’s sacred  
**Memory** • Write one moment tomorrow that made you feel alive  
**Intuition** • Follow body signals within 5 seconds  
